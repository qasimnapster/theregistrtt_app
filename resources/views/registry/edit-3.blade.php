	...
	<section>
		<div class="clearfix">
			<div class="alert alert-success">
				<h1 class="text-light text-center" ><span style="font-style:italic; font-size: inherit; color:inherit; font-weight: 700">Congratulations!</span> on Updating your Registry!'   We do hope this was one of the easier parts of your wedding!   Go and start sharing your Wedding Code with your guests!</h1>
			</div>
