...
<body>
        ...
        <div class="col-sm-12 container-navbar">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-user-o" aria-hidden="true"></i> LOGIN</a></li>
    ...
    <div class="ticker-main gradient-ticker text-center">
        Looking for ideas? Get Inspired!  <a href="#" style="font-size:24px; padding:15px; background-color: #fff; border-right:1px solid"><i class="fa fa-gift" aria-hidden="true"></i> W </a>
        <a href="#" style="font-size:24px; padding:15px; background-color: #fff; border-right:1px solid"><i class="fa fa-gift" aria-hidden="true"></i> BW </a>
        <a href="#" style="font-size:24px; padding:15px; background-color: #fff;"><i class="fa fa-gift" aria-hidden="true"></i> WL</a>
    </div>
                ...
                <div class="block-contact">
                    <div class="row">
                        <div class="clearfix">
                            ...
                            <div class="col-sm-6 col-contact-us">
                                <h3 class="text-light text-left">Lorem Design Columbia, SC</h3>
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="col-sm-5 text-right"> <h3 class="text-light"><i class="fa text-theme fa-phone"></i></h3> </div>
                            <div class="col-sm-6 col-contact-us">
                                <h3 class="text-light text-left">(123) 111-1111</h3>
                            </div>
                        </div>
                        <div class="clearfix">
                            <div class="col-sm-5 text-right"> <h3 class="text-light"><i class="fa text-theme fa-inbox"></i></h3> </div>
                            <div class="col-sm-6 col-contact-us">
